...
try {
    ...
    switch ($chartType) {
        case 'orders_trend':
            // 30-day orders trend - using exact schema
            $query = "
                SELECT 
        ...
        case 'top_products':
            // Top 10 products by units shipped - using exact schema
            $query = "
                SELECT 
                    p.name,
        ...
        case 'outlet_performance':
            // Orders by outlet - using exact schema
            $query = "
                SELECT 
        ...
        case 'warranty_trends':
            // Weekly warranty claims - using exact schema
            $query = "
                SELECT 
        ...
        case 'revenue_analysis':
            // Monthly revenue for last 12 months - using exact schema
            $query = "
                SELECT 
